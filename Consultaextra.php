...
<center><h1> Consulta tu cuenta a actualizar </center></h1><br><br>
<?php
$servidor = "localhost";
$usuario = "root";
$contraseña = "";
...
$consulta = mysqli_query($conexion, "SELECT * from usuario") or die ("Error al consultar
registros");
...
echo "<th id='Apellido_paterno'> Apellido Paterno </th>";
echo "</tr>";
...
echo "<td>".$extraido["Apellido_paterno"]."</td>";
echo "</tr>";
