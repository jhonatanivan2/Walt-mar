...
mysqli_query($conexion, "UPDATE usuario SET id='$id',Nombre='$Nombre',Apellido_paterno='$Apellido_paterno', Telefono='$Telefono',Correo='$Correo',Contrasena='$Contraseña', Confirmar_contrasena='$Confirmar_contraseña'where id='$id'")or die ("Error al actualizar registro");
