...
<font face="arial" color="black" ><h3>Iniciar sesi&oacute;n<h3></font><br>

 <div class="input-contenedor">
<input type="text" name="correo" value="" size="32" placeholder="Correo electronico"/><br><br>
<input type="password" name="contrasena" value="" size="32" placeholder="Contrase&ntilde;a"/><br><br>
</div>
<input type="image" name="iniciarsecion" src="InicioSesion.png" alt="Enviar" height="90" width="490">
</h1><br>
<font face="arial" size="3" ><p>¿Aún no tienes cuenta?</p><a href="CrearCuenta.html">Crear cuenta</a>
</font>
